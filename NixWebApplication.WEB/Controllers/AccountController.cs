...
using NixWebApplication.WEB.Models.AccountViewModels;
...
namespace NixWebApplication.WEB.Controllers
{
    ...
    {
        private readonly UserManager<NixWebApplicationUser> _userManager;
        private readonly SignInManager<NixWebApplicationUser> _signInManager;
        private readonly IEmailSender _emailSender;
        private readonly ISmsSender _smsSender;
        private readonly ILogger _logger;

        public AccountController(
            UserManager<NixWebApplicationUser> userManager,
            SignInManager<NixWebApplicationUser> signInManager,
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new NixWebApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        private Task<NixWebApplicationUser> GetCurrentUserAsync()
        {
